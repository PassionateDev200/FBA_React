...
const FileUpload = () => {
  ...
  const clearAllData = async () => {
    ...
    // Add any other application-specific data clearing here
    // This might include resetting state, clearing custom storage, etc.
      ...
      <div className="card shadow-sm border-0 p-4 text-center">
        ...
        >
          ...
          {isLoading ? (
            ...
            <>
              <div className="upload-icon-container mb-3"></div>
